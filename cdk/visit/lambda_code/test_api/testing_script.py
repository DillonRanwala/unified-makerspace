...
visit_data = {"username":"NEW_PIPELINE_TEST_"+dt_string,"location":"Watt","tool":"Visiting","ttl_expiration":(unix_timestamp_for_ttl)}
visit_data = json.dumps(visit_data)

visit_data_unregistered = {"username":"NEW_PIPELINE_TEST_UNREGISTERED"+dt_string,"location":"Watt","tool":"Visiting","ttl_expiration":(unix_timestamp_for_ttl)}
